...
<div class="d-flex row">
  ...
  <div class="d-flex col-11">
    ...
    <!-- SideBar -->
    <div class="col-1 bg-dark" style="min-height: 100%;">
      <ul class="pt-2 w-100">
          <li class="nav-item">
            <a class="nav-link text-white" aria-current="page" href="./index.php">Add New File</a>
          </li>
            <hr class="text-white">
          <li class="nav-item">
            <a class="nav-link text-white" href="./allFiles.php">All Files</a>
          </li>
      </ul>
  </div>
